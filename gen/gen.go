...
const DefaultOverridesFile = ".adalundhe"
...
var packageTemplate = `// Package {{.PackageName}} Code generated by adalundhe/swag{{ if .GeneratedTime }} at {{ .Timestamp }}{{ end }}. DO NOT EDIT
package {{.PackageName}}

import "github.com/adalundhe/swag"
